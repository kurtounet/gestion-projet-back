 ...
 */
final class Version20251202135857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE priority (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, priority_number INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE project_instance (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, icon VARCHAR(100) NOT NULL, color VARCHAR(7) NOT NULL, is_favory TINYINT NOT NULL, position INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, status_id INT NOT NULL, priority_id INT NOT NULL, project_template_id INT NOT NULL, comment_id INT DEFAULT NULL, INDEX IDX_7F7E3A056BF700BD (status_id), INDEX IDX_7F7E3A05497B19F9 (priority_id), INDEX IDX_7F7E3A05CD15F843 (project_template_id), INDEX IDX_7F7E3A05F8697D13 (comment_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE status (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, context_id INT NOT NULL, INDEX IDX_7B00651C6B00C1CF (context_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE type_task (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, path_file_script VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, automatique TINYINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, code_id INT NOT NULL, INDEX IDX_85711E2D27DAFE17 (code_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
