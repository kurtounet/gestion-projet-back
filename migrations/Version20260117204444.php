 ...
 */
final class Version20260117204444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE config_project_framework (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, configuration JSON DEFAULT NULL, architecture JSON DEFAULT NULL, script JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, framework_id INT DEFAULT NULL, INDEX IDX_9F73577137AECF72 (framework_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE framework (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(100) NOT NULL, type VARCHAR(10) NOT NULL, version VARCHAR(10) NOT NULL, description VARCHAR(250) DEFAULT NULL, configuration JSON DEFAULT NULL, icon VARCHAR(250) DEFAULT NULL, color VARCHAR(10) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, technology_id INT DEFAULT NULL, INDEX IDX_9D766E194235D463 (technology_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE project_instance (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, path_file_database VARCHAR(255) DEFAULT NULL, path_project VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, icon VARCHAR(100) DEFAULT NULL, color VARCHAR(7) DEFAULT NULL, is_favory TINYINT DEFAULT 0 NOT NULL, position INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, created_by_user VARCHAR(180) DEFAULT NULL, updated_by_user VARCHAR(180) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, status_id INT NOT NULL, priority_id INT NOT NULL, project_template_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, config_framework_id INT DEFAULT NULL, INDEX IDX_7F7E3A056BF700BD (status_id), INDEX IDX_7F7E3A05497B19F9 (priority_id), INDEX IDX_7F7E3A05CD15F843 (project_template_id), INDEX IDX_7F7E3A05F8697D13 (comment_id), INDEX IDX_7F7E3A05727ACA70 (parent_id), UNIQUE INDEX UNIQ_7F7E3A05E4AA6E05 (config_framework_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
