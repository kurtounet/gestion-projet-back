...
/**
 * Provider custom pour ProjectTemplate.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<ProjectTemplateResponseDto>
 */
final readonly class ProjectTemplateProvider implements ProviderInterface
{
