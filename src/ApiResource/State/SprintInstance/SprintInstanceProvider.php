...
/**
 * Provider custom pour SprintInstance.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<SprintInstanceResponseDto>
 */
final readonly class SprintInstanceProvider implements ProviderInterface
{
