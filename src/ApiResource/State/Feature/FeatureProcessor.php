...
/**
 * Processor custom pour Feature.
 * Décore le Processor par défaut pour ajouter une logique d'écriture si besoin.
 *
 * @implements ProcessorInterface<FeatureCreateDto|FeatureUpdateDto, FeatureResponseDto|App\Entity\Feature|void>
 */


final readonly class FeatureProcessor implements ProcessorInterface
{
