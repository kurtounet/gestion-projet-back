...
/**
 * Provider custom pour TaskInstance.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<TaskInstanceResponseDto>
 */
final readonly class TaskInstanceProvider implements ProviderInterface
{
