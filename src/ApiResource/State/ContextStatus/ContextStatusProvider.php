...
/**
 * Provider custom pour ContextStatus.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<ContextStatusResponseDto>
 */
final readonly class ContextStatusProvider implements ProviderInterface
{
