...
/**
 * Processor custom pour Priority.
 * Décore le Processor par défaut pour ajouter une logique d'écriture si besoin.
 *
 * @implements ProcessorInterface<PriorityCreateDto|PriorityUpdateDto, PriorityResponseDto|App\Entity\Priority|void>
 */


final readonly class PriorityProcessor implements ProcessorInterface
{
