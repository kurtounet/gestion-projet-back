...
/**
 * Provider custom pour SprintTemplate.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<SprintTemplateResponseDto>
 */
final readonly class SprintTemplateProvider implements ProviderInterface
{
