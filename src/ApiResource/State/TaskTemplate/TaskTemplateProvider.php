...
/**
 * Provider custom pour TaskTemplate.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<TaskTemplateResponseDto>
 */
final readonly class TaskTemplateProvider implements ProviderInterface
{
