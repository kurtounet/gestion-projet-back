...
/**
 * Processor custom pour ProjectTemplateSprintTemplate.
 * Décore le Processor par défaut pour ajouter une logique d'écriture si besoin.
 *
 * @implements ProcessorInterface<ProjectTemplateSprintTemplateCreateDto|ProjectTemplateSprintTemplateUpdateDto, ProjectTemplateSprintTemplateResponseDto|App\Entity\ProjectTemplateSprintTemplate|void>
 */


final readonly class ProjectTemplateSprintTemplateProcessor implements ProcessorInterface
{
