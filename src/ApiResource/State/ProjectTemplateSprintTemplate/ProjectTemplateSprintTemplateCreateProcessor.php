...
final readonly class ProjectTemplateSprintTemplateCreateProcessor implements ProcessorInterface
{
    ...
    private function mapDtoToEntity(ProjectTemplateSprintTemplateCreateDto $dto): ProjectTemplateSprintTemplate
    {
...
// TODO: Relations ToMany
    ...
    private function entityToDto(ProjectTemplateSprintTemplate $entity): ProjectTemplateSprintTemplateItemDto
    {
