...
/**
 * Provider custom pour ProjectTemplateSprintTemplate.
 * Décore le Provider par défaut pour ajouter une logique de lecture si besoin.
 *
 * @implements ProviderInterface<ProjectTemplateSprintTemplateResponseDto>
 */
final readonly class ProjectTemplateSprintTemplateProvider implements ProviderInterface
{
