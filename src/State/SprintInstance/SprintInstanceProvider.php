...
/**
 * Provider pour l'entité SprintInstance.
 *
 * À brancher dans la ressource API Platform :
 *  - via attribut : provider: App\State\SprintInstance\SprintInstanceProvider::class
...
final class SprintInstanceProvider implements ProviderInterface
{
    ...
    /**
     * @return SprintInstance|SprintInstance[]|null
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): object|array|null
    {
        $repository = $this->registry->getRepository(SprintInstance::class);
