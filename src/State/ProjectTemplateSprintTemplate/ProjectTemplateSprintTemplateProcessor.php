...
/**
 * Processor pour ProjectTemplateSprintTemplate.
 *
 * À brancher sur la ressource :
 * #[ApiResource(processor: ProjectTemplateSprintTemplateProcessor::class)]
 */
final class ProjectTemplateSprintTemplateProcessor implements ProcessorInterface
{
    ...
    /**
     * @param ProjectTemplateSprintTemplate|mixed $data
     */
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        // if ($operation instanceof Patch || $operation instanceof Put && $data instanceof ProjectTemplateSprintTemplateUpdateDto) {
        //     $entity = $this->em->getRepository(ProjectTemplateSprintTemplate::class)->find($data->id);
        //     $entity->setName($data->name);
        //     $entity->setDescription($data->description);
        //     $entity->setStartDate($data->startDate);
        //     $entity->setEndDate($data->endDate);
