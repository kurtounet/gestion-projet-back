...
/**
 * Processor pour Technologie.
 *
 * À brancher sur la ressource :
 * #[ApiResource(processor: TechnologieProcessor::class)]
 */
final class TechnologieProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        if ($operation instanceof Post && $data instanceof TechnologieCreateDto) {
        ...
        // if ($operation instanceof Patch || $operation instanceof Put && $data instanceof TechnologieUpdateDto) {
        //     $entity = $this->em->getRepository(Technologie::class)->find($data->id);
        //     $entity->setName($data->name);
        //     $entity->setDescription($data->description);
        //     $entity->setStartDate($data->startDate);
        //     $entity->setEndDate($data->endDate);
